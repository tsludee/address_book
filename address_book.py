...
def edit():
    ...
    # delete_box_label_editor = Label(editor, text="Select ID Number")
    # delete_box_label_editor.grid(row=9, column=0, pady=5)
...
update_btn.grid(row=12, column=0, columnspan=2, pady=10, padx=10, ipadx=141)
